    ...
    private static async Task GenerateSettingsJson()
    {
        ...
        var settings = new List<Item>
        {
            ...
            [
                ...
                new ProgressiveItemStage("Hotel", "SonicHotel", MakeImgPath("SonicHotel"), false),
                new ProgressiveItemStage("Casino", "SonicCasino", MakeImgPath("SonicCasino"), false),
                new ProgressiveItemStage("Twinkle Park Lobby", "SonicTwinkleParkLobby", MakeImgPath("SonicTwinkleParkLobby"), false),
                new ProgressiveItemStage("Mystic Ruins (Hub)", "SonicMysticRuinsMain", MakeImgPath("SonicMysticRuinsMain"), false),
                new ProgressiveItemStage("Angel Island", "SonicAngelIsland", MakeImgPath("SonicAngelIsland"), false),
                new ProgressiveItemStage("Jungle", "SonicJungle", MakeImgPath("SonicJungle"), false),
                new ProgressiveItemStage("Egg Carrier Outside", "SonicEggCarrierOutside", MakeImgPath("SonicEggCarrierOutside"), false),
            ...
            [
                ...
                new ProgressiveItemStage("Hotel", "TailsHotel", MakeImgPath("TailsHotel"), false),
                new ProgressiveItemStage("Casino", "TailsCasino", MakeImgPath("TailsCasino"), false),
                new ProgressiveItemStage("Twinkle Park Lobby", "TailsTwinkleParkLobby", MakeImgPath("TailsTwinkleParkLobby"), false),
                new ProgressiveItemStage("Mystic Ruins (Hub)", "TailsMysticRuinsMain", MakeImgPath("TailsMysticRuinsMain"), false),
                new ProgressiveItemStage("Angel Island", "TailsAngelIsland", MakeImgPath("TailsAngelIsland"), false),
                new ProgressiveItemStage("Jungle", "TailsJungle", MakeImgPath("TailsJungle"), false),
                new ProgressiveItemStage("Egg Carrier Outside", "TailsEggCarrierOutside", MakeImgPath("TailsEggCarrierOutside"), false),
            ...
            [
                ...
                new ProgressiveItemStage("Hotel", "KnucklesHotel", MakeImgPath("KnucklesHotel"), false),
                new ProgressiveItemStage("Casino", "KnucklesCasino", MakeImgPath("KnucklesCasino"), false),
                new ProgressiveItemStage("Twinkle Park Lobby", "KnucklesTwinkleParkLobby", MakeImgPath("KnucklesTwinkleParkLobby"), false),
                new ProgressiveItemStage("Mystic Ruins (Hub)", "KnucklesMysticRuinsMain", MakeImgPath("KnucklesMysticRuinsMain"), false),
                new ProgressiveItemStage("Angel Island", "KnucklesAngelIsland", MakeImgPath("KnucklesAngelIsland"), false),
                new ProgressiveItemStage("Jungle", "KnucklesJungle", MakeImgPath("KnucklesJungle"), false),
                new ProgressiveItemStage("Egg Carrier Outside", "KnucklesEggCarrierOutside", MakeImgPath("KnucklesEggCarrierOutside"), false),
            ...
            [
                ...
                new ProgressiveItemStage("Hotel", "AmyHotel", MakeImgPath("AmyHotel"), false),
                new ProgressiveItemStage("Casino", "AmyCasino", MakeImgPath("AmyCasino"), false),
                new ProgressiveItemStage("Twinkle Park Lobby", "AmyTwinkleParkLobby", MakeImgPath("AmyTwinkleParkLobby"), false),
                new ProgressiveItemStage("Mystic Ruins (Hub)", "AmyMysticRuinsMain", MakeImgPath("AmyMysticRuinsMain"), false),
                new ProgressiveItemStage("Angel Island", "AmyAngelIsland", MakeImgPath("AmyAngelIsland"), false),
                new ProgressiveItemStage("Jungle", "AmyJungle", MakeImgPath("AmyJungle"), false),
                new ProgressiveItemStage("Egg Carrier Outside", "AmyEggCarrierOutside", MakeImgPath("AmyEggCarrierOutside"), false),
            ...
            [
                ...
                new ProgressiveItemStage("Hotel", "GammaHotel", MakeImgPath("GammaHotel"), false),
                new ProgressiveItemStage("Casino", "GammaCasino", MakeImgPath("GammaCasino"), false),
                new ProgressiveItemStage("Twinkle Park Lobby", "GammaTwinkleParkLobby", MakeImgPath("GammaTwinkleParkLobby"), false),
                new ProgressiveItemStage("Mystic Ruins (Hub)", "GammaMysticRuinsMain", MakeImgPath("GammaMysticRuinsMain"), false),
                new ProgressiveItemStage("Angel Island", "GammaAngelIsland", MakeImgPath("GammaAngelIsland"), false),
                new ProgressiveItemStage("Jungle", "GammaJungle", MakeImgPath("GammaJungle"), false),
                new ProgressiveItemStage("Egg Carrier Outside", "GammaEggCarrierOutside", MakeImgPath("GammaEggCarrierOutside"), false),
            ...
            [
                ...
                new ProgressiveItemStage("Hotel", "BigHotel", MakeImgPath("BigHotel"), false),
                new ProgressiveItemStage("Casino", "BigCasino", MakeImgPath("BigCasino"), false),
                new ProgressiveItemStage("Twinkle Park Lobby", "BigTwinkleParkLobby", MakeImgPath("BigTwinkleParkLobby"), false),
                new ProgressiveItemStage("Mystic Ruins (Hub)", "BigMysticRuinsMain", MakeImgPath("BigMysticRuinsMain"), false),
                new ProgressiveItemStage("Angel Island", "BigAngelIsland", MakeImgPath("BigAngelIsland"), false),
                new ProgressiveItemStage("Jungle", "BigJungle", MakeImgPath("BigJungle"), false),
                new ProgressiveItemStage("Egg Carrier Outside", "BigEggCarrierOutside", MakeImgPath("BigEggCarrierOutside"), false),
                new ProgressiveItemStage("Egg Carrier Inside", "BigEggCarrierInside", MakeImgPath("BigEggCarrierInside"), false),
                new ProgressiveItemStage("Egg Carrier Front Deck", "BigEggCarrierFrontDeck", MakeImgPath("BigEggCarrierFrontDeck"), false)
            ]),
